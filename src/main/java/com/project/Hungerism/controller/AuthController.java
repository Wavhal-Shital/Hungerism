...
import com.project.Hungerism.config.JwtProvider;
...
import com.project.Hungerism.request.LoginRequest;
import com.project.Hungerism.response.AuthResponse;
import com.project.Hungerism.service.CustomerUserDetailsService;
...
public class AuthController {
    ...
    private Authentication authenticate(String username, String password){
        ...
        if(userDetails==null){
            throw new BadCredentialsException("invalid username...", null);
